  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[80vh] gap-6">
      ...
      <form className="flex flex-col gap-4 w-full max-w-xs" onSubmit={handleSubmit}>
        <input name="name" type="text" placeholder="Name" className="px-4 py-2 rounded border" required />
      ...
      <p className="text-sm">Already have an account? <Link href="/auth/login" className="text-blue-600 hover:underline">Login</Link></p>
    </main>
  );
} 