  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div>
          <textarea
            className="w-full border-none outline-none bg-transparent text-gray-600 dark:text-gray-300 placeholder-gray-500 dark:placeholder-gray-400 resize-none"
          ...
          <div key={idx} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-1 space-y-3">
                ...
                <select
                  className="w-48 border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
                  value={q.type}
                ...
                {/* Question Label */}
                <input
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
            ...
            {(q.type === "multiple_choice" || q.type === "checkbox" || q.type === "dropdown") && (
              <div className="space-y-3 mt-4 pl-4 border-l-2 border-gray-200 dark:border-gray-600">
